        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('edit_user',$user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Salary <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="decimal" name="salary" class="form-control col-md-7 col-xs-12" value="{{ $user->salary }}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="department_id" class="form-control col-md-7 col-xs-12">
                            @foreach($departments as $department)
                                ...
                                @if(!empty($user->user_department->department))
                                
                                    @if($department->id == $user->user_department->department->id)
